...
/* 
Below states if the members who joined are more than 5 in value then
execute the following code to welcome all 5 together (can be set to any integral value (1,2,3,etc.)
*/

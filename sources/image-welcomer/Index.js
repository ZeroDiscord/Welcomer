...
const { token, PREFIX, unicolor, imageLink, channel } = require('./config.json')
...
// Login with the token make sure to add it when starting
...
client.on('guildMemberAdd', async member => {
    ...
    member.guild.channels.cache.find(c => c.id === channel).send({
